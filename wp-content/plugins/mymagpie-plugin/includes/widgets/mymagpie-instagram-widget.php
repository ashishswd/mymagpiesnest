<?php
	class Mymagpie_Instagram_Widget extends WP_Widget {
		/* constructor */
		public function Mymagpie_Instagram_Widget() {
			parent::WP_Widget(false, __('Mymagpie - Instagram', MYMAGPIE_PLUGIN_DOMAIN), array('description' => __('Widget for popular social network Instagram', MYMAGPIE_PLUGIN_DOMAIN)));
		}
		...
		public function widget($args, $instance) {
			...
			$button_text = apply_filters( 'mymagpie_text_translate', $instance['button_text'], $instance['title'] . ' button_text' );
		...
		public function form($instance) {
			...
			$form_field_type = array(
				'title' => array('type' => 'text', 'class' => 'widefat', 'inline_style' => '',  'title' => __('Widget Title', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $title),
				'user_name' => array('type' => 'text', 'class' => 'widefat',  'inline_style' => '', 'title' => __('User Name', MYMAGPIE_PLUGIN_DOMAIN), 'description' => 'Widget will work only for users who have full rights opened in Instagram account.', 'value' => $user_name),
				'image_counter' => array('type' => 'text', 'class' => 'widefat', 'inline_style' => '', 'title' => __('Number of displayed images', MYMAGPIE_PLUGIN_DOMAIN), 'description' => __('Max value: 20 images.', MYMAGPIE_PLUGIN_DOMAIN), 'value' => $image_counter),
				'image_size' => array('type' => 'select', 'class' => 'widefat', 'inline_style' => '', 'title' => __('Image dimentions', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $image_size, 'value_options' => array('large' => __('Large', MYMAGPIE_PLUGIN_DOMAIN), 'thumbnail' => __('Thumbnail', MYMAGPIE_PLUGIN_DOMAIN)) ),
				'display_description' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Show  image description', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $display_description),
				'display_comments' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Show comments number', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $display_comments),
				'display_likes' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Show likes number', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $display_likes),
				'display_time' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Show image publication date', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $display_time),
				'link' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Image URL', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $link),
				'button_text' => array('type' => 'text', 'class' => 'widefat',  'inline_style' => '', 'title' => __('User account button text', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $button_text)
			);
			$output = '';
