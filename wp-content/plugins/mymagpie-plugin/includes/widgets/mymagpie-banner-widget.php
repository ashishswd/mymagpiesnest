<?php
	class Mymagpie_Banner_Widget extends WP_Widget {
		/* constructor */
		public function Mymagpie_Banner_Widget() {
			parent::WP_Widget(false, __('Mymagpie - Banner', MYMAGPIE_PLUGIN_DOMAIN), array('description'=>'Mymagpie Banner Widget'));
		...
		public function form($instance) {
			...
			$form_field_type = array(
				'title' => array('type' => 'text', 'class' => 'widefat', 'inline_style' => '',  'title' => __('Title', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $title),
				'description_text' => array('type' => 'textarea', 'class' => 'widefat', 'inline_style' => '',  'title' => __('Banner description', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $description_text),
				'image_url' => array('type' => 'upload', 'class' => 'widefat', 'inline_style' => '', 'title' => __('Image URL', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $image_url),
				'fill' => array('type' => 'checkbox', 'class' => '', 'inline_style' => '', 'title' => __('Fill image', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $fill),
				'link_url' => array('type' => 'text', 'class' => 'widefat', 'inline_style' => '', 'title' => __('Link URL', MYMAGPIE_PLUGIN_DOMAIN), 'description' => '', 'value' => $link_url)
			);
			...
			foreach ($form_field_type as $key => $args) {
				...
				switch ($args['type']) {
					...
					case 'upload':
						...
						$output .= '<input style="margin: 10px 0" class="upload_image_button button button-primary" type="button" value="'.__('Select Image', MYMAGPIE_PLUGIN_DOMAIN).'" />';
					break;
				}
		...
		public function upload_scripts(){
				...
				wp_enqueue_script('upload_media_widget', MYMAGPIE_PLUGIN_URL . 'admin/js/upload-media-files.js');
		}
