...
class MY_CycleWidget extends WP_Widget {
	...
	function MY_CycleWidget() {
		parent::WP_Widget(false, $name = __('Mymagpie - Post Cycle', MYMAGPIE_PLUGIN_DOMAIN));
	}
	...
	function widget($args, $instance) {
		...
		$more_text_single = apply_filters( 'mymagpie_text_translate', $instance['more_text_single'], $instance['title'] . ' more_text_single' );
					...
					while ( $post_cycle->have_posts() ) :
						...
						<li class="slide <?php echo $format; ?> clearfix">
							...
							<?php }
								...
								if ( $show_author ) { ?>
								<em class="author">
									<span><?php _e('by', MYMAGPIE_PLUGIN_DOMAIN); ?></span>
							...
							<?php }
								...
								if ( $show_comments ) {
									...
									if ( $comment_count > 1 ) :
										$comment_count = $comment_count . ' <span>' . __( 'Comments', MYMAGPIE_PLUGIN_DOMAIN ) . '</span>';
									else :
										$comment_count = $comment_count . ' <span>' . __( 'Comment', MYMAGPIE_PLUGIN_DOMAIN ) . '</span>';
									endif;
							...
							if ( $more_text_single != '' ) { ?>
								<a href="<?php echo get_permalink( $post_id ); ?>" title="<?php echo $post_title_attr; ?>" class="btn btn-primary"><?php _e( $more_text_single, MYMAGPIE_PLUGIN_DOMAIN ); ?></a>
							<?php } ?>
						</li><!-- .slide -->
						<?php }
					endwhile;
	...
	<p><label for="<?php echo $this->get_field_id('post_type'); ?>"><?php _e('Select post type:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('categories'); ?>"><?php _e('Categories (names separated by ","):', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" id="<?php echo $this->get_field_id('categories'); ?>" name="<?php echo $this->get_field_name('categories'); ?>" type="text" value="<?php echo $categories; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Posts count:', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" style="width:60px; display:block; text-align:center" id="<?php echo $this->get_field_id('count'); ?>" name="<?php echo $this->get_field_name('count'); ?>" type="number" value="<?php echo $count; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('thumb_width'); ?>"><?php _e('Thumbnail Width (in pixels):', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" style="width:60px; display:block; text-align:center" id="<?php echo $this->get_field_id('thumb_width'); ?>" name="<?php echo $this->get_field_name('thumb_width'); ?>" type="number" value="<?php echo $thumb_width; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('thumb_height'); ?>"><?php _e('Thumbnail Height (in pixels):', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" style="width:60px; display:block; text-align:center" id="<?php echo $this->get_field_id('thumb_height'); ?>" name="<?php echo $this->get_field_name('thumb_height'); ?>" type="number" value="<?php echo $thumb_height; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('show_title'); ?>"><?php _e('Show titles:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
		<select id="<?php echo $this->get_field_id('show_title'); ?>" name="<?php echo $this->get_field_name('show_title'); ?>" style="width:100%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;" >
			<?php
				...
				$option .= '>' . __('yes', MYMAGPIE_PLUGIN_DOMAIN) . '</option>';
				$option .= '<option value="false"';
				if ($show_title == 'false') {
					$option .= ' selected="selected"';
				}
				$option .= '>' . __('no', MYMAGPIE_PLUGIN_DOMAIN) . '</option>';
				echo $option;
			?>
		</select>
		</label>
	...
	<p><label for="<?php echo $this->get_field_id('show_date'); ?>"><?php _e('Show date:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('show_author'); ?>"><?php _e('Show author:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('show_comments'); ?>"><?php _e('Show comments:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php _e('Show excerpt:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('excerpt_count'); ?>"><?php _e('Excerpt word count:', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" style="width:60px; display:block; text-align:center" id="<?php echo $this->get_field_id('excerpt_count'); ?>" name="<?php echo $this->get_field_name('excerpt_count'); ?>" type="number" value="<?php echo $excerpt_count; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('more_text_single'); ?>"><?php _e('More Button Text:', MYMAGPIE_PLUGIN_DOMAIN); ?> <input class="widefat" id="<?php echo $this->get_field_id('more_text_single'); ?>" name="<?php echo $this->get_field_name('more_text_single'); ?>" type="text" value="<?php echo $more_text_single; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('speed'); ?>"><?php _e('Slideshow cycling speed (in sec.):', MYMAGPIE_PLUGIN_DOMAIN); ?><input class="widefat" style="width:50px; display:block; text-align:center" id="<?php echo $this->get_field_id('speed'); ?>" name="<?php echo $this->get_field_name('speed'); ?>" type="number" value="<?php echo $speed; ?>" /></label></p>

	<p><label for="<?php echo $this->get_field_id('direction_nav'); ?>"><?php _e('Arrows:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
	...
	<p><label for="<?php echo $this->get_field_id('control_nav'); ?>"><?php _e('Pagination:', MYMAGPIE_PLUGIN_DOMAIN); ?><br />
