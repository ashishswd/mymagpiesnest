...
class Ad_125_125_Widget extends WP_Widget {
	...
	function Ad_125_125_Widget() {
		$widget_ops = array(
			...
			'description' => __('Add 125x125 ads.', MYMAGPIE_PLUGIN_DOMAIN),
			);
		$control_ops = array( 'id_base' => 'ad_125_125-widget' );
		$this->WP_Widget( 'ad_125_125-widget', __( 'Mymagpie - 125x125 Ads', MYMAGPIE_PLUGIN_DOMAIN ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p><strong><?php _e('Ad 1', MYMAGPIE_PLUGIN_DOMAIN); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_1'); ?>"><?php _e('Image Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_1'); ?>"><?php _e('Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p><strong><?php _e('Ad 2', MYMAGPIE_PLUGIN_DOMAIN); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_2'); ?>"><?php _e('Image Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_2'); ?>"><?php _e('Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p><strong><?php _e('Ad 3', MYMAGPIE_PLUGIN_DOMAIN); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_3'); ?>"><?php _e('Image Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_3'); ?>"><?php _e('Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p><strong><?php _e('Ad 4', MYMAGPIE_PLUGIN_DOMAIN); ?></strong></p>
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_img_4'); ?>"><?php _e('Image Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('ad_125_link_4'); ?>"><?php _e('Ad Link:', MYMAGPIE_PLUGIN_DOMAIN); ?></label>
