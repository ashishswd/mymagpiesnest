...
function MY_PostsTypeWidget() {
	$widget_ops = array('classname' => 'my_posts_type_widget', 'description' => __('Show custom posts', MYMAGPIE_PLUGIN_DOMAIN));
	$control_ops = array('width' => 510, 'height' => 350);
	parent::WP_Widget(false, __('Mymagpie - Advanced Cycle', MYMAGPIE_PLUGIN_DOMAIN), $widget_ops, $control_ops);
}
...
function widget($args, $instance) {
	...
	$more_link_text = apply_filters( 'mymagpie_text_translate', $instance['more_link_text'], $instance['title'] . ' more_link_text' );
	$global_link_text = apply_filters( 'mymagpie_text_translate', $instance['global_link_text'], $instance['title'] . ' global_link_text' );
	...
	?>
	  ...
	  <?php if ( $instance['more_link'] ) : ?>
		<a href="<?php the_permalink() ?>" class="btn btn-primary <?php if($instance['more_link_class']!="") {echo $instance['more_link_class'];}else{ ?>link<?php } ?>"><?php if($instance['more_link_text']==""){ _e('Read more', MYMAGPIE_PLUGIN_DOMAIN); }else{ ?><?php echo $more_link_text; ?><?php } ?></a>
	  <?php endif; ?>
		</li><!--//.post-list_li -->
	...
	<?php if ( $instance['global_link'] ) : ?>
	  <a href="<?php echo $instance['global_link_href']; ?>" class="btn btn-primary link_show_all"><?php if($instance['global_link_text']==""){ _e('View all', MYMAGPIE_PLUGIN_DOMAIN); }else{ ?><?php echo $global_link_text; ?><?php } ?></a>
	<?php endif; ?>
...
?>
  ...
  <p>
	<label for="<?php echo $this->get_field_id("title"); ?>">
		<?php _e('Title', MYMAGPIE_PLUGIN_DOMAIN); ?>:
  ...
  <p>
	  <label>
		  <?php _e('Posts type', MYMAGPIE_PLUGIN_DOMAIN); ?>:
		  <?php $args=array(); ?>
  ...
  <p>
	  <label for="<?php echo $this->get_field_id("num"); ?>">
		  <?php _e('Number of posts to show', MYMAGPIE_PLUGIN_DOMAIN); ?>:
...
<p>
	...
	<?php _e('Sort by', MYMAGPIE_PLUGIN_DOMAIN); ?>:
...
<p>
  <label for="<?php echo $this->get_field_id("asc_sort_order"); ?>">
	<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("asc_sort_order"); ?>" name="<?php echo $this->get_field_name("asc_sort_order"); ?>" value="1" <?php checked( (bool) $instance["asc_sort_order"], true ); ?> />
		  <?php _e('Reverse sort order (ascending)', MYMAGPIE_PLUGIN_DOMAIN); ?>
  </label>
</p>
<p>
  <label for="<?php echo $this->get_field_id("comment_num"); ?>">
	  <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("comment_num"); ?>" name="<?php echo $this->get_field_name("comment_num"); ?>"<?php checked( (bool) $instance["comment_num"], true ); ?> />
	  <?php _e('Show number of comments', MYMAGPIE_PLUGIN_DOMAIN); ?>
  </label>
</p>
...
<p>
  <label for="<?php echo $this->get_field_id("date"); ?>">
	  ...
	  <?php _e('Show meta', MYMAGPIE_PLUGIN_DOMAIN); ?>
  </label>
</p>

<p>
  <label for="<?php echo $this->get_field_id("container_class"); ?>">
	<?php _e('Container class', MYMAGPIE_PLUGIN_DOMAIN); ?>:
	<input class="widefat" id="<?php echo $this->get_field_id("container_class"); ?>" name="<?php echo $this->get_field_name("container_class"); ?>" type="text" value="<?php echo esc_attr($instance["container_class"]); ?>" /> <span style="font-size:11px; color:#999;">(<?php _e('default: "featured_custom_posts"', MYMAGPIE_PLUGIN_DOMAIN); ?>)</span>
  </label>
</p>

  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Post title', MYMAGPIE_PLUGIN_DOMAIN); ?>:</legend>
  <p>
	  <label for="<?php echo $this->get_field_id("show_title"); ?>">
		  ...
		  <?php _e('Show post title', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  <p>
	  <label for="<?php echo $this->get_field_id("show_title_date"); ?>">
		  ...
		  <?php _e('Date as title ', MYMAGPIE_PLUGIN_DOMAIN); ?> <span style='font-size:11px; color:#999;'>('[mm-dd-yyyy]')</span>
	  </label>
  </p>
  ...
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Excerpt', MYMAGPIE_PLUGIN_DOMAIN); ?>:</legend>
  <p>
	  <label for="<?php echo $this->get_field_id("excerpt"); ?>">
		  <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("excerpt"); ?>" name="<?php echo $this->get_field_name("excerpt"); ?>"<?php checked( (bool) $instance["excerpt"], true ); ?> />
		  <?php _e('Show post excerpt', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  <p>
	  <label for="<?php echo $this->get_field_id("excerpt_length"); ?>">
		  <?php _e('Excerpt length (words)', MYMAGPIE_PLUGIN_DOMAIN); ?>:
	  </label>
  ...
  <p>
	  <label for="<?php echo $this->get_field_id("excerpt_as_link"); ?>">
		  ...
		  <?php _e('Excerpt as link', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  </fieldset>
</div>
<div style="width:230px; float:left; padding-left:20px;">
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('More link', MYMAGPIE_PLUGIN_DOMAIN); ?>:</legend>
  <p>
	  <label for="<?php echo $this->get_field_id("more_link"); ?>">
		  ...
		  <?php _e('Show "More link', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>

  <p>
  <label for="<?php echo $this->get_field_id("more_link_text"); ?>">
	<?php _e('Link Text', MYMAGPIE_PLUGIN_DOMAIN); ?>:
	<input class="widefat" id="<?php echo $this->get_field_id("more_link_text"); ?>" name="<?php echo $this->get_field_name("more_link_text"); ?>" type="text" value="<?php echo esc_attr($instance["more_link_text"]); ?>" /> <span style="font-size:11px; color:#999;">(<?php _e('default: "Read more"', MYMAGPIE_PLUGIN_DOMAIN); ?>)</span>
  </label>
  </p>
  <p>
  <label for="<?php echo $this->get_field_id("more_link_class"); ?>">
	<?php _e('Link class', MYMAGPIE_PLUGIN_DOMAIN); ?>:
	<input class="widefat" id="<?php echo $this->get_field_id("more_link_class"); ?>" name="<?php echo $this->get_field_name("more_link_class"); ?>" type="text" value="<?php echo esc_attr($instance["more_link_class"]); ?>" /> <span style="font-size:11px; color:#999;">(<?php _e('default: "link"', MYMAGPIE_PLUGIN_DOMAIN); ?>)</span>
  </label>
  </p>
  </fieldset>
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Thumbnail dimensions', MYMAGPIE_PLUGIN_DOMAIN); ?>:</legend>
  ...
  <p>
	  <label for="<?php echo $this->get_field_id("thumb"); ?>">
		  ...
		  <?php _e('Show post thumbnail', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  <p>
		  <label for="<?php echo $this->get_field_id("thumb_w"); ?>">
			  <?php _e('Width', MYMAGPIE_PLUGIN_DOMAIN); ?>: &nbsp;&nbsp;<input class="widefat" style="width:40%;" type="text" id="<?php echo $this->get_field_id("thumb_w"); ?>" name="<?php echo $this->get_field_name("thumb_w"); ?>" value="<?php echo absint($instance["thumb_w"]); ?>" />
		  </label>
  </p>
  <p>
		  <label for="<?php echo $this->get_field_id("thumb_h"); ?>">
			  <?php _e('Height', MYMAGPIE_PLUGIN_DOMAIN); ?>: <input class="widefat" style="width:40%;" type="text" id="<?php echo $this->get_field_id("thumb_h"); ?>" name="<?php echo $this->get_field_name("thumb_h"); ?>" value="<?php echo absint($instance["thumb_h"]); ?>" />
		  </label>
  </p>
  <p>
	  <label for="<?php echo $this->get_field_id("thumb_as_link"); ?>">
		  ...
		  <?php _e('Thumbnail as link', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  </fieldset>
  <fieldset style="border:1px solid #F1F1F1; padding:10px 10px 0; margin-bottom:1em;">
  <legend style="padding:0 5px;"><?php _e('Link to all posts', MYMAGPIE_PLUGIN_DOMAIN); ?>:</legend>
  <p>
	  <label for="<?php echo $this->get_field_id("global_link"); ?>">
		  ...
		  <?php _e('Show global link to all posts', MYMAGPIE_PLUGIN_DOMAIN); ?>
	  </label>
  </p>
  <p>
  <label for="<?php echo $this->get_field_id("global_link_text"); ?>">
	<?php _e('Link Text', MYMAGPIE_PLUGIN_DOMAIN); ?>:
	<input class="widefat" id="<?php echo $this->get_field_id("global_link_text"); ?>" name="<?php echo $this->get_field_name("global_link_text"); ?>" type="text" value="<?php echo esc_attr($instance["global_link_text"]); ?>" /> <span style="font-size:11px; color:#999;">(<?php _e('default: "View all"', MYMAGPIE_PLUGIN_DOMAIN); ?>)</span>
  </label>
  </p>
  <p>
	  <label for="<?php echo $this->get_field_id("global_link_href"); ?>">
		  <?php _e('Link URL', MYMAGPIE_PLUGIN_DOMAIN); ?>:
