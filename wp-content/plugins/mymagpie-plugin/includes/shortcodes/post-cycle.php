...
if (!function_exists('shortcode_post_cycle')) {
	...
	function shortcode_post_cycle( $atts, $content = null, $shortcodename = '' ) {
		extract(shortcode_atts(array(
				...
				'thumb_width'      => '200',
				'thumb_height'     => '180',
				'more_text_single' => __('Read more', MYMAGPIE_PLUGIN_DOMAIN),
				'category'         => '',
				'custom_category'  => '',
				'excerpt_count'    => '15',
				'pagination'       => 'true',
			...
			foreach($latest as $key => $post) {
				...
				$output .= '<li class="list-item-'.$count.'">';
					...
					if($meta == 'true'){
						...
						$output .= get_the_date();
						$output .= '</span>';
						$output .= '<span class="post-comments">'.__('Comments', MYMAGPIE_PLUGIN_DOMAIN).": ";
					...
					switch( $type_post ) {
						...
						case "portfolio":
							...
							$output .="<strong class='portfolio-meta-key'>".__('Client', MYMAGPIE_PLUGIN_DOMAIN).": </strong><span> ".$portfolioClient."</span><br>";
							$output .="<strong class='portfolio-meta-key'>".__('Date', MYMAGPIE_PLUGIN_DOMAIN).": </strong><span> ".$portfolioDate."</span><br>";
							$output .="<strong class='portfolio-meta-key'>".__('Info', MYMAGPIE_PLUGIN_DOMAIN).": </strong><span> ".$portfolioInfo."</span><br>";
							$output .="<a href='".$portfolioURL."'>".__('Launch Project', MYMAGPIE_PLUGIN_DOMAIN)."</a><br>";
							break;
