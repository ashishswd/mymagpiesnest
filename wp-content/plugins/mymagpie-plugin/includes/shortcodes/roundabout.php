...
if (!function_exists('shortcode_roundabout')) {
	function shortcode_roundabout( $atts, $content = null, $shortcodename = '' ) {
		...
		wp_enqueue_script( 'roundabout_script', MYMAGPIE_PLUGIN_URL . 'lib/js/roundabout/jquery.roundabout.min.js', array('jquery') );
		wp_enqueue_script( 'roundabout_shape', MYMAGPIE_PLUGIN_URL . 'lib/js/roundabout/jquery.roundabout-shapes.min.js', array('jquery') );
