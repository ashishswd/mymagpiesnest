	...
	function shortcode_recent_posts( $atts, $content = null, $shortcodename = '' ) {
		...
		foreach($latest as $k => $post) {
											...
											<div class="jp-interface">
												...
												<div class="jp-controls-holder">
													<ul class="jp-controls">
														<li><a href="javascript:;" class="jp-previous" tabindex="1" title="'.__('Previous', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Previous', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
														<li><a href="javascript:;" class="jp-play" tabindex="1" title="'.__('Play', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Play', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
														<li><a href="javascript:;" class="jp-pause" tabindex="1" title="'.__('Pause', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Pause', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
														<li><a href="javascript:;" class="jp-next" tabindex="1" title="'.__('Next', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Next', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
														<li><a href="javascript:;" class="jp-stop" tabindex="1" title="'.__('Stop', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Stop', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
													</ul>
													<div class="jp-volume-bar">
														<div class="jp-volume-bar-value"></div>
													</div>
													<ul class="jp-toggles">
														<li><a href="javascript:;" class="jp-mute" tabindex="1" title="'.__('Mute', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Mute', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
														<li><a href="javascript:;" class="jp-unmute" tabindex="1" title="'.__('Unmute', MYMAGPIE_PLUGIN_DOMAIN).'"><span>'.__('Unmute', MYMAGPIE_PLUGIN_DOMAIN).'</span></a></li>
													</ul>
												</div>
											</div>
											<div class="jp-no-solution">
												<span>'.__('Update Required.', MYMAGPIE_PLUGIN_DOMAIN).'</span>'.__('To play the media you will need to either update your browser to a recent version or update your ', MYMAGPIE_PLUGIN_DOMAIN).'<a href="http://get.adobe.com/flashplayer/" target="_blank">'.__('Flash plugin', MYMAGPIE_PLUGIN_DOMAIN).'</a>
											</div>
										</div>
									</div>
				...
				//Standard
					...
					$output .= mymagpie_get_post_networks(array('post_id' => $post->ID, 'display_title' => false, 'output_type' => 'return'));
					if ($excerpt_count >= 1) {
						$output .= '<div class="excerpt">';
							$output .= my_string_limit_words($excerpt,$excerpt_count);
						$output .= '</div>';
