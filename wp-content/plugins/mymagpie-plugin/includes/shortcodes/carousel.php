					...
					foreach ( $carousel_posts as $key => $post ) {
						...
						$output .= '<li class="es-carousel_li ' . $format . ' clearfix list-item-'.$itemcount.'">';
							...
							$output .= '<div class="desc">';
								...
								// post author
								if ( $author == 'yes' ) {
									$output .= '<em class="author">&nbsp;<span>' . __('by', MYMAGPIE_PLUGIN_DOMAIN) . '</span>&nbsp;<a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '">' . get_the_author_meta( 'display_name' ) . '</a> </em>';
								}
