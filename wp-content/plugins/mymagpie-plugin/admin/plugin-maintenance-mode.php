...
<form method="post" action="options.php">
	<table class="form-table">
		<tbody>
			<tr valign="top">
				<th scope="row">
					<?php _e('Maintenance Mode', 'mymagpie-plugin') ?>
				</th>
				<td>
					<label for="mtc_mode_on">
						...
						<?php _e('Enable this option to activate website maintenance mode.', 'mymagpie-plugin') ?>
					</label>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row">
					<?php _e('Display Logo?', 'mymagpie-plugin') ?>
				</th>
				<td>
					<label for="mtc_mode_logo">
						...
						<?php _e('Enable this option to display website logo at the under construction page', 'mymagpie-plugin') ?>
					</label>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row">
					<?php _e('Description', 'mymagpie-plugin') ?>
				</th>
				<td>
					<p>
			...
			<tr valign="top">
				<th scope="row">
					<?php _e('Display timer?', 'mymagpie-plugin') ?>
				</th>
				<td>
			...
			<tr valign="top">
				<th scope="row" class="date_input">
					<?php _e('Website launch date.', 'mymagpie-plugin'); ?><br>
					<span class="error"><?php _e('Date is not correct.', 'mymagpie-plugin') ?></span>
				</th>
				<td>
					<p>
						<label for="mtc_mode_year" class="small_size" ><?php _e('Year:', 'mymagpie-plugin') ?></label>
						<input name="mtc_mode_year" type="text" id="mtc_mode_year" value="<?php echo $set_date['year'] ?>" class="small-text" maxlength="4">
						<label for="mtc_mode_month" class="small_size" ><?php _e('Month:', 'mymagpie-plugin') ?></label>
						<input name="mtc_mode_month" type="text" id="mtc_mode_month" value="<?php echo $set_date['month'] ?>" class="small-text" maxlength="2">
						<label for="mtc_mode_day" class="small_size" ><?php _e('Day:', 'mymagpie-plugin') ?></label>
						<input name="mtc_mode_day" type="text" id="mtc_mode_day" value="<?php echo $set_date['day'] ?>" class="small-text" maxlength="2">
					</p>
					<p>
						<label for="mtc_mode_hour" class="small_size" ><?php _e('Hour:', 'mymagpie-plugin') ?></label>
						<input name="mtc_mode_hour" type="text" id="mtc_mode_hour" value="<?php echo $set_date['hours'] ?>" class="small-text" maxlength="2">
						<label for="mtc_mode_minute" class="small_size" ><?php _e('Minute:', 'mymagpie-plugin') ?></label>
	...
	<p>
		<a id="mtc_save" class="button button-primary float-left" href="#"><?php _e('Save Changes', 'mymagpie-plugin'); ?></a><span class="spinner" style="float:left; margin:4px 0 0 8px; "></span>
	</p>
</form>