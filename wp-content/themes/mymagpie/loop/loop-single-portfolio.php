...
<?php if (have_posts()) : while (have_posts()) : the_post();
	...
	$left_block = $fullwidth ? mymagpie_get_layout_class( 'left_block' ) : mymagpie_get_layout_class( 'full_width_content' ) ;
	$right_block = $fullwidth ? mymagpie_get_layout_class( 'right_block' ) : mymagpie_get_layout_class( 'full_width_content' ) ;
