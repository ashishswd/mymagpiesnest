...
/*-----------------------------------------------------------------------------------*/
function mymagpie_scripts() {
	if (!is_admin()) {
		// MymagpieFramework Scripts
		...
		if ( (CURRENT_THEME!='mymagpie') && (file_exists(CHILD_DIR. '/includes/widgets/my-flickr-widget.php')) ) {
...
add_action('wp_enqueue_scripts', 'mymagpie_scripts');

/*-----------------------------------------------------------------------------------*/
/*	Register and load stylesheet
/*-----------------------------------------------------------------------------------*/
function mymagpie_stylesheets() {
...
add_action('wp_enqueue_scripts', 'mymagpie_stylesheets');
