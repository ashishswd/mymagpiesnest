...
/* Add a menu page called "Mymagpie Options" */

if ( !function_exists( 'optionsframework_add_page' ) ) {
	function optionsframework_add_page() {
		$of_page = add_menu_page(theme_locals("mymagpie_options"), theme_locals("mymagpie_options"), 'edit_theme_options', 'options-framework', 'optionsframework_page', OPTIONS_FRAMEWORK_DIRECTORY.'images/mymagpie-icon.png', 61);
...
/* Add a subpage called "Data Management" to the Mymagpie Options. */
...
/* Add a subpage called "SEO" to the Mymagpie Options. */
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => theme_locals("mymagpie_options"),
