<?php
	function theme_local_init() {
		global $is_mymagpie_local_init, $mymagpie_locals_arr;
		if ($is_mymagpie_local_init) return true;

		$domain = CURRENT_THEME;
		$mymagpie_locals_arr = array(
			//general
			'no' => __('No', 'mymagpie'),
			'yes' => __('Yes', $domain),
			...
			//Mymagpie theme options
			'mymagpie_options' => __('Mymagpie Options', $domain),
			...
			'congratulations_msg' => __('You have successfully installed your <b>Mymagpie WordPress Theme</b>.<br /> You can look theme now', $domain),
			...
			'warning_notice_2' => __('Mymagpie Framework is not able to perform necessary changes for the correct work with your child theme.', $domain),
			...
			'top_1' => __('Top Area 1', $domain),
			'home_1' => __('Home Area 1', $domain),
			'home_2' => __('Home Area 2', $domain),
			'home_3' => __('Home Area 3', $domain),
			'home_4' => __('Home Area 4', $domain),
			...
			'add_125_125_desc' => __('Mymagpie - 125x125 Ads', $domain),
			'ad_1' => __('Ad 1', $domain),
			'ad_2' => __('Ad 2', $domain),
			'ad_3' => __('Ad 3', $domain),
			'ad_4' => __('Ad 4', $domain),
			...
			'recent_comments' => __('Mymagpie - Recent Comments', $domain),
			...
			//my-recent-posts
			'recent_posts' => __('Mymagpie - Recent Posts', $domain),
			...
			'social_networks' => __('Mymagpie - Social Networks', $domain),
			...
			'facebook_widget_name' => __('Mymagpie - Facebook Like Box Widget', $domain),
			'facebook_widget_disc' => __('Mymagpie - Facebook Like Box Widget', $domain),
			...
			'mymagpie_store' => __('Mymagpie Store', $domain),
			...
			'mymagpie_framework' => __('Mymagpie Framework', $domain),
			...
			'new_version' => __('There is a new version of Mymagpie framework available', $domain),
		...
		$is_mymagpie_local_init = true;
	};

	function theme_locals($label) {
		global $mymagpie_locals_arr;
		theme_local_init();
		return $mymagpie_locals_arr[$label];
	};
?>