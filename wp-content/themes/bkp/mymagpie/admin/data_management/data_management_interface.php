<?php
	...
	@define('PARENT_NAME', 'MymagpieFramework');
				...
				<div id="optionsframework" class="postbox store-holder">
					<div class="wrap">
						...
						<div class="data_management">
							...
							<div class="theme_box">
								<h4><?php echo theme_locals('mymagpie_framework'); ?></h4>
							...
							<?php
								...
								foreach ($themes as $theme) {
									if(is_dir("$themes_dir/$theme")){
										if(strtolower(get_theme_info($theme, 'Template')) == 'mymagpieframework' && strtolower($theme) != 'mymagpieframework'){
							...
							<div class="theme_box">
								...
								<div class="buttons_controls">
									<div class="button_wrapper">
										<a class="button-primary backup_theme" href="MymagpieFramework"  title="<?php echo theme_locals('backup'); ?>"><?php echo theme_locals("backup"); ?></a>
									</div>
									<div class="button_wrapper">
										<a class="button-primary restore_theme" href="MymagpieFramework" title="<?php echo theme_locals('restore'); ?>"><?php echo theme_locals("restore"); ?></a>
									</div>
									<div class="button_wrapper">
										<a class="button-primary download_backup" href="MymagpieFramework" title="<?php echo theme_locals('download_backup'); ?>"><?php echo theme_locals("download_backup"); ?></a>
									</div>
								</div>
								<?php }else{
									printf('<p><em>'.theme_locals('warning_notice_1').' '.theme_locals('warning_notice_3').'</em></p>');
