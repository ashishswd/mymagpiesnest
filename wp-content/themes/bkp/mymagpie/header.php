...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo PARENT_URL; ?>/css/responsive.css">
	<link rel="stylesheet" type="text/css" href="<?php echo PARENT_URL; ?>/css/font-awesome.min.css">
	<script src="<?php echo PARENT_URL; ?>/js/magpie/jquery_1_11_1.js"></script>
	<script src="<?php echo PARENT_URL; ?>/js/magpie/modernizr.js"></script>
	<script src="<?php echo PARENT_URL; ?>/js/magpie/html5shiv.js"></script>
	<link rel="stylesheet" href="<?php echo PARENT_URL; ?>/css/tabs/jquery-ui.css">
	<script src="<?php echo PARENT_URL; ?>/js/tabs/jquery-ui.js"></script>
	<script src="<?php echo PARENT_URL; ?>/js/accordion/SpryAccordion.js"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo PARENT_URL; ?>/css/accordion/SpryAccordion.css">
	<?php
	...
	<!--[if gte IE 9]><!-->
		...
		<script type="text/javascript">
			jQuery(function(){
				jQuery('.sf-menu').mobileMenu({defaultText: <?php echo '"' . apply_filters( 'mymagpie_text_translate', of_get_option('mobile_menu_label'), 'mobile_menu_label' ) . '"'; ?>});
			});
		</script>
	<!--<![endif]-->
	<script type="text/javascript">
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			if(!device.mobile() && !device.tablet()){
				jQuery('<?php echo apply_filters( "mymagpie_stickmenu_selector", ".header .nav__primary" ); ?>').tmStickUp({
					correctionSelector: jQuery('#wpadminbar')
				,	listenSelector: jQuery('<?php echo apply_filters( "mymagpie_stickmenu_listen_selector", ".listenSelector" ); ?>')
				,	active: <?php echo (of_get_option('stickup_menu', 'false')=="false") ? 'false' : 'true'; ?>
				,   pseudo: <?php echo apply_filters( "mymagpie_stickmenu_option_pseudo", "true" ); ?>
				});
			}
		})
	</script>
...
<section class="header_wrapper">
	...
	<div id="motopress-main" class="main-holder">
		...
		<header class="motopress-wrapper header">
			<div class="container">
				<div class="row">
					<div class="<?php echo mymagpie_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="wrapper/wrapper-header.php" data-motopress-wrapper-type="header" data-motopress-id="<?php echo uniqid() ?>">
					</div>
				</div>
			</div>
		</header>