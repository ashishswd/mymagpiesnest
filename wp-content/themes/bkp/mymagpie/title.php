<section class="contact_header_wrapper">
	<header class="contact_header content_wrapper">
		<span class="back_2_home"><a href="<?php echo home_url(); ?>"><i class="fa fa-caret-left"></i>back to : Home</a></span>
	<h1 class="title-header">
		<?php
			...
			if(is_home()){ ?>
			<?php $blog_text = apply_filters( 'mymagpie_text_translate', of_get_option('blog_text'), 'blog_text' ); ?>
				<?php if($blog_text){?>
					<?php echo $blog_text; ?>
				<?php } else { ?>
...
/* End shop */
	...
	<?php }
	?>
		<span class="go_2_products"><a href="<?php echo get_permalink(8); ?>">go to : Products <i class="fa fa-caret-right"></i></a></span>
		<div class="clear"></div>
	</header>  
</section>