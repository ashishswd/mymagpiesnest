...
<div class="motopress-wrapper content-holder clearfix">
	<div class="container">
		<div class="row">
			<div class="<?php echo mymagpie_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="page-archives.php" data-motopress-wrapper-type="content">
				<div class="row">
				...
				<div class="row">
					<div class="<?php echo mymagpie_get_layout_class( 'content' ); ?> <?php echo of_get_option('blog_sidebar_pos') ?>" id="content" data-motopress-type="loop" data-motopress-loop-file="loop/loop-archives.php">
